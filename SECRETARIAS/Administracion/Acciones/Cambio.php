<?php
    ...
    $Persona = "SELECT * FROM secretarias_cuentas WHERE id_encargado = $ID;";
        ...
        <form method="POST" enctype="multipart/form-data">
            <fieldset>
                ...
                <div>
                    ...
                    <input type="text" id="Cargo" class="No_Contestar" value="<?php echo $Empleado['cargo_actual'];?>" readonly required>
                </div>
                <!--Cargo a cambiar-->
                <div>
                    <label for="CargoCambiar">Cargo a cambiar: </label>
                    <input type="text" id="CargoCambiar" class="No_Contestar" value="<?php echo $Empleado['cargo_nuevo'];?>" readonly required>
                </div>
                <!--Cambio permanente-->
                <div>
