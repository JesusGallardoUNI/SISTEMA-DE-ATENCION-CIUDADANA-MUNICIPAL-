            ...
            <table class="Configurar Configurar__Mediano Configurar__Mediano__Centro Configurar__General">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input id="Sol5" type="number" readonly value="<?php echo Estadistica(5, "si")?>"></td>
                    ...
                    <tr>
                        ...
                        <td><input type="number" value="<?php echo Descartados(5, "si")?>" name="Descartado5" id="Descartado5"></td>
