<?php
    ...
    $db = ConectarDB();
    //$filtro = $_SESSION['Reporte'];
    //=======================================================//
    //  Aqui empiezo a buscar todos los reportes necesarios  //
    //=======================================================//
    $Buscar = "SELECT * FROM reportes_colonias WHERE resuelto != 'si' AND tipo_reporte = {$_SESSION['Reporte']}";
...
<body>
    <?php Banner(true,"../../Recursos/Imagenes/icono.png","Atención Ciudadana","Da clic a la clave del reporte para continuar",true,"../../Recursos/SVG/Cerrar.svg","../../Recursos/Partes/Salir.php"); ?>
